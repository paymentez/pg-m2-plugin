...
Install a specific version.  `composer require paymentez/payment-gateway:2.1.7`
...
## Maintenance
If you need update the plugin to latest version execute: `composer update paymentez/payment-gateway` or `composer require paymentez/payment-gateway:2.1.7` for specific version.
