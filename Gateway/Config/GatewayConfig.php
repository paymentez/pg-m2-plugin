...
use Paymentez\PaymentGateway\Helper\FooLogger;
use Paymentez\PaymentGateway\Helper\Logger;
use Paymentez\PaymentGateway\Model\Adminhtml\Source\Env;

class GatewayConfig extends Config
{
    // === CONSTANTS === //
    const GATEWAY_CODE = 'paymentez_gateway';
    const CODE = 'paymentez_gateway';
    const ACTIVE = 'active';
    const TITLE = 'title';
